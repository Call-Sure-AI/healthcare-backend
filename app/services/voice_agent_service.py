...
class VoiceAgentService:
    ...
    def _resolve_doctor_id(self, input_id: str, available_doctors: List[Dict]) -> str:
        ...
        try:
            ...
            print(f"   ⚠️ No match found for '{input_id}'")
            return None
            ...
            if function_name in ["get_available_slots", "book_appointment"]:
                ...
                if doctor_id and doctor_id.startswith("DOC"):
                    ...
                    if valid:
                        ...
                        print(f"   ⚠️ doctor_id {doctor_id} not in available doctors, will resolve...")
                        doctor_id = None  # Force resolution
                ...
                if not doctor_id or not doctor_id.startswith("DOC"):
                    ...
                    if selected_doctor_id:
                        ...
                        if resolved_id:
                            ...
                            print(f"   ⚠️ Defaulting to first doctor: {available_doctors[0]['doctor_id']}")
                    else:
